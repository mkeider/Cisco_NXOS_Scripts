...
#################################################################################################
#Script connects to cisco_nxos device extracts cdp neighbor data, parses with textfsm, then     #
#outputs to .csv "nxos_cdp_neighbor.csv"                                                        #
#################################################################################################
...
with open('nxos_cdp_results.json', 'w') as results_file:
    json.dump(results, results_file, indent=2)


with open('nxos_cdp_neighbor.csv','w', newline='')as new_file:
   fieldnames = ['local_host','neighbor','local_interface','holdtime', 'capability', 'platform', 'neighbor_interface']
