...
#################################################################################################
#Script connects to cisco_nxos device extracts OSPF neighbor data, parses with textfsm, then    #
#outputs to .csv "nxos_ospf_neighbor.csv"                                                       #
#################################################################################################
...
for device in devices:
    ...
    try:
        ...
        print(local_host)
        output = connection.send_command("show ip ospf neighbor vrf all", use_textfsm=True)##textfsm integrated into Netmiko
...
with open('nxos_ospf_results.json', 'w') as results_file:
    json.dump(results, results_file, indent=2)


with open('nxos_ospf_neighbor.csv','w', newline='')as new_file:
   fieldnames = ['local_host','interface','local_ipaddr','neighbor_ipaddr', 'ospf_pid', 'state', 'uptime','vrf']
