...
#################################################################################################
#Script connects to cisco_nxos device extracts vlan data, parses with textfsm, then             #
#outputs to .csv "nxos_vlan.csv"                                                                #
#################################################################################################
...
with open('nxos_vlan_results.json', 'w') as results_file:
    json.dump(results, results_file, indent=2)


with open('nxos_vlan.csv','w', newline='')as new_file:
   fieldnames = ['local_host','name','status','vlan_id']
