...
#################################################################################################
#Script connects to cisco_nxos device extracts show version data, parses with textfsm, then     #
#outputs to .csv "nxos_version.csv"                                                             #
#################################################################################################
...
with open('nxos_version_results.json', 'w') as results_file:
    json.dump(results, results_file, indent=2)


with open('nxos_version.csv','w', newline='')as new_file:
   fieldnames = ['local_host','boot_image','last_reboot_reason','os','platform','uptime']
